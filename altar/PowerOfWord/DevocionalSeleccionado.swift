...
class DevocionalSeleccionado: UIViewController {
   ...
   //     view.addSubview(textoDevocional)
    ...
    @objc func postEdit (){
            ...
            let uidtoEdit = advengers.shared.devocionalSeleccinado.devoUID
                
                let ref = userPostRef.child(uidtoEdit!)
                var fondo = advengers.shared.devocionalSeleccinado.photoURL
...
extension DevocionalSeleccionado: UITextViewDelegate {
...
extension DevocionalSeleccionado: UITextFieldDelegate {
